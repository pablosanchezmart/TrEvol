...
initializeTrEvo <- function(folder.name = "simulations"){
  ...
  dir.create(paste0(results.dir, "/figures/phylogeneticSignal_plots/"), showWarnings = F)
  dir.create(paste0(results.dir, "/figures/VCV_networks/"), showWarnings = F)
  dir.create(paste0(results.dir, "/figures/conditional_VCV_networks/"), showWarnings = F)
  dir.create(paste0(results.dir, "/figures/example/"), showWarnings = F)
